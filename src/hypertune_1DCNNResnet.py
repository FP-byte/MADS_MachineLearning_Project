...
def hypertune_1Dmodels():
    ...
    config = {
        ...
        config_param.gru_hidden: tune.choice([32, 64, 128, 256, 512]), # hidden units for gru
        ...
        #config_param.hidden: 16, # hidden units for cnn bottleneck cnn
        ...
        config_param.earlystopping_patience: 10, # wait time if netwerk is not learning before stopping
        config_param.input_length:192, #input for gru model
